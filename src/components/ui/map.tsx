    ...
    return (
        ...
        >
            ...
            <MapMarker longitude={center[0]} latitude={center[1]}>
                <MarkerContent>
                    {/* Modern shadcn-like marker */}
                    <div className="relative flex items-center justify-center">
                        <div className="absolute h-10 w-10 animate-ping rounded-full bg-brand-orange/20" />
                        <div className="relative flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-brand-orange shadow-lg transition-transform hover:scale-110">
