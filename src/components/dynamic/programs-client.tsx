...
interface ProgramsClientProps {
    ...
    initialCategories: ProgramCategory[];
}

export function ProgramsClient({ initialPrograms, initialCategories }: ProgramsClientProps) {
                                        ...
                                        <div className="space-y-2 mb-4">
                                            {program.target_beneficiaries && (
                                                ...
                                                >
                                                    ...
                                                    {program.target_beneficiaries} Beneficiaries
                                                </motion.div>
                                            )}
