      ...
      <div className="container mx-auto px-4 md:px-8 relative z-20 -mt-24 mb-24">
        ...
        >
          ...
          <div className="lg:w-[450px] bg-brand-blue text-white p-8 md:p-12 flex flex-col relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-green/20 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-orange/20 rounded-full blur-3xl -translate-x-1/3 translate-y-1/3 pointer-events-none" />
